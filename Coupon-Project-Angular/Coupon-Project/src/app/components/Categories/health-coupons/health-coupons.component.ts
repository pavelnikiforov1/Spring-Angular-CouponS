...
@Component({
  selector: 'app-health-coupons',
  templateUrl: './health-coupons.component.html',
  styleUrls: ['./health-coupons.component.css']
})
export class HEALThCouponsComponent implements OnInit {
  ...
  ngOnInit() {
    this.utilityServise.getAllCouponsWhereTypeIsHEALTHInCategorie().subscribe(c =>{
      this.coupons = c ;
      var amount:number = 0;
       var dlt:number = 0 ;
