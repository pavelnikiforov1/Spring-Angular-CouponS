...
@Component({
  selector: 'app-restaurant-coupons',
  templateUrl: './restaurant-coupons.component.html',
  styleUrls: ['./restaurant-coupons.component.css']
})
export class RestaurantCouponsComponent implements OnInit {
  ...
  ngOnInit() {
    this.utilityServise.getAllCouponsWhereTypeIsRESTURANSInCategorie().subscribe(c =>{
      this.coupons = c ;
      var amount:number = 0;
       var dlt:number = 0 ;
